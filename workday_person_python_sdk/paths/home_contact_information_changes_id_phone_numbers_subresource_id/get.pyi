...
class BaseApi(api_client.Api):
    ...
    def _get_staged_phone_number_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_staged_phone_number_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/homeContactInformationChanges/{ID}/phoneNumbers/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_staged_phone_number_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetStagedPhoneNumberRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_staged_phone_number(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_staged_phone_number_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_staged_phone_number_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_staged_phone_number(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_staged_phone_number_oapg(
            path_params=args.path,
        )

class GetStagedPhoneNumber(BaseApi):
    ...
    async def aget_staged_phone_number(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_staged_phone_number(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_staged_phone_number(
        ...
        raw_response = self.raw.get_staged_phone_number(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
