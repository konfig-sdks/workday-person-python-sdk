...
from workday_person_python_sdk.model.people_get_preferred_name_response import PeopleGetPreferredNameResponse as PeopleGetPreferredNameResponseSchema
...
from workday_person_python_sdk.type.people_get_preferred_name_response import PeopleGetPreferredNameResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.people_get_preferred_name_response import PeopleGetPreferredNameResponse as PeopleGetPreferredNameResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetPreferredNameResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetPreferredNameResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_preferred_name_mapped_args(
        self,
        id: str,
    ...
    async def _aget_preferred_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/preferredName',
            headers=_headers,
        )
...
class GetPreferredNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_preferred_name(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_preferred_name_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_preferred_name_oapg(
    ...
    def get_preferred_name(
        ...
        return self._get_preferred_name_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPreferredName(BaseApi):
    ...
    async def aget_preferred_name(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetPreferredNameResponsePydantic:
        raw_response = await self.raw.aget_preferred_name(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return PeopleGetPreferredNameResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetPreferredNameResponsePydantic, raw_response.body)
    ...
    def get_preferred_name(
        ...
        raw_response = self.raw.get_preferred_name(
            id=id,
            limit=limit,
            offset=offset,
        )
