...
from workday_person_python_sdk.model.web_address33e26848dc0010003893a0202ced0165 import WebAddress33e26848dc0010003893a0202ced0165 as WebAddress33e26848dc0010003893a0202ced0165Schema
...
from workday_person_python_sdk.pydantic.web_address33e26848dc0010003893a0202ced0165 import WebAddress33e26848dc0010003893a0202ced0165 as WebAddress33e26848dc0010003893a0202ced0165Pydantic
...
SchemaFor200ResponseBodyApplicationJson = WebAddress33e26848dc0010003893a0202ced0165Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WebAddress33e26848dc0010003893a0202ced0165
...
class BaseApi(api_client.Api):
    ...
    def _get_home_web_address_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_home_web_address_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/homeWebAddresses/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_home_web_address_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetHomeWebAddressRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_home_web_address(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_home_web_address_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_home_web_address_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_home_web_address(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_home_web_address_oapg(
            path_params=args.path,
        )

class GetHomeWebAddress(BaseApi):
    ...
    async def aget_home_web_address(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebAddress33e26848dc0010003893a0202ced0165Pydantic:
        raw_response = await self.raw.aget_home_web_address(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[WebAddress33e26848dc0010003893a0202ced0165Pydantic](raw_response.body).root
        return api_client.construct_model_instance(WebAddress33e26848dc0010003893a0202ced0165Pydantic, raw_response.body)
    ...
    def get_home_web_address(
        ...
        raw_response = self.raw.get_home_web_address(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
