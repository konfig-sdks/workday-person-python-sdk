...
class BaseApi(api_client.Api):
    ...
    def _get_legal_name_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_legal_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/legalName/{subresourceID}',
            headers=_headers,
        )
...
class GetLegalNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_legal_name(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_legal_name_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_legal_name_oapg(
    ...
    def get_legal_name(
        ...
        return self._get_legal_name_oapg(
            path_params=args.path,
        )

class GetLegalName(BaseApi):
    ...
    async def aget_legal_name(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_legal_name(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_legal_name(
        ...
        raw_response = self.raw.get_legal_name(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
