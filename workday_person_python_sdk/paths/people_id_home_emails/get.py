...
from workday_person_python_sdk.model.people_get_home_emails_response import PeopleGetHomeEmailsResponse as PeopleGetHomeEmailsResponseSchema
...
from workday_person_python_sdk.type.people_get_home_emails_response import PeopleGetHomeEmailsResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.people_get_home_emails_response import PeopleGetHomeEmailsResponse as PeopleGetHomeEmailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetHomeEmailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetHomeEmailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_home_emails_mapped_args(
        self,
        id: str,
    ...
    async def _aget_home_emails_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/homeEmails',
            headers=_headers,
        )
...
class GetHomeEmailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_home_emails(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_home_emails_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_home_emails_oapg(
    ...
    def get_home_emails(
        ...
        return self._get_home_emails_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetHomeEmails(BaseApi):
    ...
    async def aget_home_emails(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetHomeEmailsResponsePydantic:
        raw_response = await self.raw.aget_home_emails(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
        ...
        if validate:
            return PeopleGetHomeEmailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetHomeEmailsResponsePydantic, raw_response.body)
    ...
    def get_home_emails(
        ...
        raw_response = self.raw.get_home_emails(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
