...
from workday_person_python_sdk.model.person_public_representation_d8f2aecf3d63100016a77ab413a20235 import PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 as PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Schema
...
from workday_person_python_sdk.pydantic.person_public_representation_d8f2aecf3d63100016a77ab413a20235 import PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235 as PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Pydantic
...
SchemaFor200ResponseBodyApplicationJson = PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235
...
class BaseApi(api_client.Api):
    ...
    def _get_public_contact_information_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_public_contact_information_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/publicContactInformation/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_public_contact_information_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPublicContactInformationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_public_contact_information(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_public_contact_information_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_public_contact_information_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_public_contact_information(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_public_contact_information_oapg(
            path_params=args.path,
        )

class GetPublicContactInformation(BaseApi):
    ...
    async def aget_public_contact_information(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Pydantic:
        raw_response = await self.raw.aget_public_contact_information(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Pydantic](raw_response.body).root
        return api_client.construct_model_instance(PersonPublicRepresentationD8f2aecf3d63100016a77ab413a20235Pydantic, raw_response.body)
    ...
    def get_public_contact_information(
        ...
        raw_response = self.raw.get_public_contact_information(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
