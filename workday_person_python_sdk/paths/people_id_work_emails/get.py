...
from workday_person_python_sdk.model.people_get_work_emails_response import PeopleGetWorkEmailsResponse as PeopleGetWorkEmailsResponseSchema
...
from workday_person_python_sdk.type.people_get_work_emails_response import PeopleGetWorkEmailsResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.people_get_work_emails_response import PeopleGetWorkEmailsResponse as PeopleGetWorkEmailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetWorkEmailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetWorkEmailsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_work_emails_mapped_args(
        self,
        id: str,
    ...
    async def _aget_work_emails_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/workEmails',
            headers=_headers,
        )
...
class GetWorkEmailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_work_emails(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_work_emails_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_work_emails_oapg(
    ...
    def get_work_emails(
        ...
        return self._get_work_emails_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetWorkEmails(BaseApi):
    ...
    async def aget_work_emails(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetWorkEmailsResponsePydantic:
        raw_response = await self.raw.aget_work_emails(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
        ...
        if validate:
            return PeopleGetWorkEmailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetWorkEmailsResponsePydantic, raw_response.body)
    ...
    def get_work_emails(
        ...
        raw_response = self.raw.get_work_emails(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
