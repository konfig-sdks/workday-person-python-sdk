...
from workday_person_python_sdk.model.people_get_home_phones_response import PeopleGetHomePhonesResponse as PeopleGetHomePhonesResponseSchema
...
from workday_person_python_sdk.type.people_get_home_phones_response import PeopleGetHomePhonesResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.people_get_home_phones_response import PeopleGetHomePhonesResponse as PeopleGetHomePhonesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetHomePhonesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetHomePhonesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_home_phones_mapped_args(
        self,
        id: str,
    ...
    async def _aget_home_phones_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/homePhones',
            headers=_headers,
        )
...
class GetHomePhonesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_home_phones(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_home_phones_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_home_phones_oapg(
    ...
    def get_home_phones(
        ...
        return self._get_home_phones_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetHomePhones(BaseApi):
    ...
    async def aget_home_phones(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetHomePhonesResponsePydantic:
        raw_response = await self.raw.aget_home_phones(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
        ...
        if validate:
            return PeopleGetHomePhonesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetHomePhonesResponsePydantic, raw_response.body)
    ...
    def get_home_phones(
        ...
        raw_response = self.raw.get_home_phones(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
