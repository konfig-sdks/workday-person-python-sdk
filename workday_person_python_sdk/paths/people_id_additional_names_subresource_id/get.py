...
class BaseApi(api_client.Api):
    ...
    def _get_additional_name_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_additional_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/additionalNames/{subresourceID}',
            headers=_headers,
        )
...
class GetAdditionalNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_additional_name(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_additional_name_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_additional_name_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_additional_name(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_additional_name_oapg(
            path_params=args.path,
        )

class GetAdditionalName(BaseApi):
    ...
    async def aget_additional_name(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_additional_name(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_additional_name(
        ...
        raw_response = self.raw.get_additional_name(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
