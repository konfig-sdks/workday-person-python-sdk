...
class BaseApi(api_client.Api):
    ...
    def _remove_web_address_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aremove_web_address_oapg(
        self,
...
class RemoveWebAddressRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_web_address(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._remove_web_address_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aremove_web_address_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_web_address(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._remove_web_address_oapg(
            path_params=args.path,
        )

class RemoveWebAddress(BaseApi):
    ...
    async def aremove_web_address(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_web_address(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def remove_web_address(
        ...
        raw_response = self.raw.remove_web_address(
            id=id,
            subresource_id=subresource_id,
        )
