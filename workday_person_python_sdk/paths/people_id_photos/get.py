...
from workday_person_python_sdk.model.people_get_personal_photos_response import PeopleGetPersonalPhotosResponse as PeopleGetPersonalPhotosResponseSchema
...
from workday_person_python_sdk.type.people_get_personal_photos_response import PeopleGetPersonalPhotosResponse
...
from workday_person_python_sdk.pydantic.people_get_personal_photos_response import PeopleGetPersonalPhotosResponse as PeopleGetPersonalPhotosResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetPersonalPhotosResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetPersonalPhotosResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_personal_photos_mapped_args(
        self,
        id: str,
    ...
    async def _aget_personal_photos_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/photos',
            headers=_headers,
        )
...
class GetPersonalPhotosRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_personal_photos(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_personal_photos_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_personal_photos_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_personal_photos(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_personal_photos_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPersonalPhotos(BaseApi):
    ...
    async def aget_personal_photos(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetPersonalPhotosResponsePydantic:
        raw_response = await self.raw.aget_personal_photos(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return PeopleGetPersonalPhotosResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetPersonalPhotosResponsePydantic, raw_response.body)
    ...
    def get_personal_photos(
        ...
        raw_response = self.raw.get_personal_photos(
            id=id,
            limit=limit,
            offset=offset,
        )
