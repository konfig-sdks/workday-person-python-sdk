...
class BaseApi(api_client.Api):
    ...
    def _get_title_components_mapped_args(
        self,
    ...
    async def _aget_title_components_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/values/nameComponents/title',
            headers=_headers,
        )
    ...
    def _get_title_components_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTitleComponentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_title_components(
        self,
        country: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_title_components_mapped_args(
            country=country,
            limit=limit,
            offset=offset,
        )
        return await self._aget_title_components_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_title_components(
        self,
        country: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_title_components_oapg(
            query_params=args.query,
        )

class GetTitleComponents(BaseApi):
    ...
    async def aget_title_components(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_title_components(
            country=country,
            limit=limit,
            offset=offset,
            **kwargs,
    ...
    def get_title_components(
        ...
        raw_response = self.raw.get_title_components(
            country=country,
            limit=limit,
            offset=offset,
        )
