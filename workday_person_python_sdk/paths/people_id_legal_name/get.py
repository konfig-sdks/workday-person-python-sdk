...
from workday_person_python_sdk.model.people_get_legal_name_response import PeopleGetLegalNameResponse as PeopleGetLegalNameResponseSchema
...
from workday_person_python_sdk.type.people_get_legal_name_response import PeopleGetLegalNameResponse
...
from workday_person_python_sdk.pydantic.people_get_legal_name_response import PeopleGetLegalNameResponse as PeopleGetLegalNameResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetLegalNameResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetLegalNameResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_legal_name_0_mapped_args(
        self,
        id: str,
    ...
    async def _aget_legal_name_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/legalName',
            headers=_headers,
        )
...
class GetLegalName0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_legal_name_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_legal_name_0_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_legal_name_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_legal_name_0(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        return self._get_legal_name_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetLegalName0(BaseApi):
    ...
    async def aget_legal_name_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetLegalNameResponsePydantic:
        raw_response = await self.raw.aget_legal_name_0(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return PeopleGetLegalNameResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetLegalNameResponsePydantic, raw_response.body)
    ...
    def get_legal_name_0(
        ...
        raw_response = self.raw.get_legal_name_0(
            id=id,
            limit=limit,
            offset=offset,
        )
