...
from workday_person_python_sdk.model.people_get_work_phones_response import PeopleGetWorkPhonesResponse as PeopleGetWorkPhonesResponseSchema
...
from workday_person_python_sdk.type.people_get_work_phones_response import PeopleGetWorkPhonesResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.people_get_work_phones_response import PeopleGetWorkPhonesResponse as PeopleGetWorkPhonesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetWorkPhonesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetWorkPhonesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_work_phones_mapped_args(
        self,
        id: str,
    ...
    async def _aget_work_phones_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/workPhones',
            headers=_headers,
        )
...
class GetWorkPhonesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_work_phones(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_work_phones_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        ...
        return await self._aget_work_phones_oapg(
    ...
    def get_work_phones(
        ...
        return self._get_work_phones_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetWorkPhones(BaseApi):
    ...
    async def aget_work_phones(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetWorkPhonesResponsePydantic:
        raw_response = await self.raw.aget_work_phones(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
        ...
        if validate:
            return PeopleGetWorkPhonesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetWorkPhonesResponsePydantic, raw_response.body)
    ...
    def get_work_phones(
        ...
        raw_response = self.raw.get_work_phones(
            id=id,
            limit=limit,
            offset=offset,
            primary_only=primary_only,
