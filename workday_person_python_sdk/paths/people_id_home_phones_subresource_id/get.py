...
from workday_person_python_sdk.model.phone_reference_df014bc8b5fa10000af0fe7cb0ab00dd import PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00dd as PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddSchema
...
from workday_person_python_sdk.pydantic.phone_reference_df014bc8b5fa10000af0fe7cb0ab00dd import PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00dd as PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddPydantic
...
SchemaFor200ResponseBodyApplicationJson = PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00dd
...
class BaseApi(api_client.Api):
    ...
    def _get_home_phone_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_home_phone_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/homePhones/{subresourceID}',
            headers=_headers,
        )
...
class GetHomePhoneRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_home_phone(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_home_phone_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_home_phone_oapg(
    ...
    def get_home_phone(
        ...
        return self._get_home_phone_oapg(
            path_params=args.path,
        )

class GetHomePhone(BaseApi):
    ...
    async def aget_home_phone(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddPydantic:
        raw_response = await self.raw.aget_home_phone(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddPydantic](raw_response.body).root
        return api_client.construct_model_instance(PhoneReferenceDf014bc8b5fa10000af0fe7cb0ab00ddPydantic, raw_response.body)
    ...
    def get_home_phone(
        ...
        raw_response = self.raw.get_home_phone(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
