...
from workday_person_python_sdk.model.people_get_additional_names_response import PeopleGetAdditionalNamesResponse as PeopleGetAdditionalNamesResponseSchema
...
from workday_person_python_sdk.type.people_get_additional_names_response import PeopleGetAdditionalNamesResponse
...
from workday_person_python_sdk.pydantic.people_get_additional_names_response import PeopleGetAdditionalNamesResponse as PeopleGetAdditionalNamesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetAdditionalNamesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetAdditionalNamesResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_additional_names_mapped_args(
        self,
        id: str,
    ...
    async def _aget_additional_names_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/additionalNames',
            headers=_headers,
        )
    ...
    def _get_additional_names_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAdditionalNamesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_additional_names(
        self,
        id: str,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_additional_names_mapped_args(
            id=id,
            limit=limit,
            offset=offset,
        )
        return await self._aget_additional_names_oapg(
    ...
    def get_additional_names(
        ...
        return self._get_additional_names_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAdditionalNames(BaseApi):
    ...
    async def aget_additional_names(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetAdditionalNamesResponsePydantic:
        raw_response = await self.raw.aget_additional_names(
            id=id,
            limit=limit,
            offset=offset,
            **kwargs,
        ...
        if validate:
            return PeopleGetAdditionalNamesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetAdditionalNamesResponsePydantic, raw_response.body)
    ...
    def get_additional_names(
        ...
        raw_response = self.raw.get_additional_names(
            id=id,
            limit=limit,
            offset=offset,
        )
