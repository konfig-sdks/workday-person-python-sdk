...
from workday_person_python_sdk.model.countries_get_collection_information_response import CountriesGetCollectionInformationResponse as CountriesGetCollectionInformationResponseSchema
...
from workday_person_python_sdk.type.countries_get_collection_information_response import CountriesGetCollectionInformationResponse

from ...api_client import Dictionary
from workday_person_python_sdk.pydantic.countries_get_collection_information_response import CountriesGetCollectionInformationResponse as CountriesGetCollectionInformationResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CountriesGetCollectionInformationResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CountriesGetCollectionInformationResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_collection_information_mapped_args(
        self,
    ...
    async def _aget_collection_information_oapg(
        self,
    ...
    def _get_collection_information_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCollectionInformationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_collection_information(
        self,
        limit: typing.Optional[int] = None,
        offset: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_collection_information_mapped_args(
            limit=limit,
            offset=offset,
        )
        return await self._aget_collection_information_oapg(
    ...
    def get_collection_information(
        ...
        return self._get_collection_information_oapg(
            query_params=args.query,
        )

class GetCollectionInformation(BaseApi):
    ...
    async def aget_collection_information(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CountriesGetCollectionInformationResponsePydantic:
        raw_response = await self.raw.aget_collection_information(
            limit=limit,
            offset=offset,
            **kwargs,
        )
        if validate:
            return CountriesGetCollectionInformationResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CountriesGetCollectionInformationResponsePydantic, raw_response.body)
    ...
    def get_collection_information(
        ...
        raw_response = self.raw.get_collection_information(
            limit=limit,
            offset=offset,
        )
        if validate:
