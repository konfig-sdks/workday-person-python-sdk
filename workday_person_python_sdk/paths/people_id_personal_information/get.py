...
from workday_person_python_sdk.model.people_get_personal_info_response import PeopleGetPersonalInfoResponse as PeopleGetPersonalInfoResponseSchema
...
from workday_person_python_sdk.type.people_get_personal_info_response import PeopleGetPersonalInfoResponse
...
from workday_person_python_sdk.pydantic.people_get_personal_info_response import PeopleGetPersonalInfoResponse as PeopleGetPersonalInfoResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PeopleGetPersonalInfoResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PeopleGetPersonalInfoResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_personal_info_mapped_args(
        self,
        id: str,
    ...
    async def _aget_personal_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/personalInformation',
            headers=_headers,
        )
...
class GetPersonalInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_personal_info(
        self,
        id: str,
        country: typing.Optional[str] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_personal_info_mapped_args(
            id=id,
            country=country,
            limit=limit,
            offset=offset,
        )
        return await self._aget_personal_info_oapg(
    ...
    def get_personal_info(
        ...
        return self._get_personal_info_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetPersonalInfo(BaseApi):
    ...
    async def aget_personal_info(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PeopleGetPersonalInfoResponsePydantic:
        raw_response = await self.raw.aget_personal_info(
            id=id,
            country=country,
            limit=limit,
            offset=offset,
        ...
        if validate:
            return PeopleGetPersonalInfoResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleGetPersonalInfoResponsePydantic, raw_response.body)
    ...
    def get_personal_info(
        ...
        raw_response = self.raw.get_personal_info(
            id=id,
            country=country,
            limit=limit,
            offset=offset,
