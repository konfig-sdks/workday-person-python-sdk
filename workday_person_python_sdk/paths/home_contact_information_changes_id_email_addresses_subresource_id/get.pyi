...
SchemaFor200ResponseBodyApplicationJson = EmailAddressReference0918d433e86b100018119edc1b8f00f7Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_email_address_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_email_address_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/homeContactInformationChanges/{ID}/emailAddresses/{subresourceID}',
            headers=_headers,
        )
...
class GetEmailAddressRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_email_address(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_email_address_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_email_address_oapg(
    ...
    def get_email_address(
        ...
        return self._get_email_address_oapg(
            path_params=args.path,
        )

class GetEmailAddress(BaseApi):
    ...
    async def aget_email_address(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_email_address(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
    ...
    def get_email_address(
        ...
        raw_response = self.raw.get_email_address(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
