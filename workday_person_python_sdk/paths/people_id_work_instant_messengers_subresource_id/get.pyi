...
from workday_person_python_sdk.model.instant_messenger_account33e26848dc00100036f723337ebb0132 import InstantMessengerAccount33e26848dc00100036f723337ebb0132 as InstantMessengerAccount33e26848dc00100036f723337ebb0132Schema
...
from workday_person_python_sdk.pydantic.instant_messenger_account33e26848dc00100036f723337ebb0132 import InstantMessengerAccount33e26848dc00100036f723337ebb0132 as InstantMessengerAccount33e26848dc00100036f723337ebb0132Pydantic
...
SchemaFor200ResponseBodyApplicationJson = InstantMessengerAccount33e26848dc00100036f723337ebb0132Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: InstantMessengerAccount33e26848dc00100036f723337ebb0132
...
class BaseApi(api_client.Api):
    ...
    def _get_work_instant_messenger_username_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_work_instant_messenger_username_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/workInstantMessengers/{subresourceID}',
            headers=_headers,
        )
    ...
    def _get_work_instant_messenger_username_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetWorkInstantMessengerUsernameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_work_instant_messenger_username(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_work_instant_messenger_username_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_work_instant_messenger_username_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_work_instant_messenger_username(
        self,
        id: str,
        subresource_id: str,
    ) -> typing.Union[
        ...
        return self._get_work_instant_messenger_username_oapg(
            path_params=args.path,
        )

class GetWorkInstantMessengerUsername(BaseApi):
    ...
    async def aget_work_instant_messenger_username(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InstantMessengerAccount33e26848dc00100036f723337ebb0132Pydantic:
        raw_response = await self.raw.aget_work_instant_messenger_username(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[InstantMessengerAccount33e26848dc00100036f723337ebb0132Pydantic](raw_response.body).root
        return api_client.construct_model_instance(InstantMessengerAccount33e26848dc00100036f723337ebb0132Pydantic, raw_response.body)
    ...
    def get_work_instant_messenger_username(
        ...
        raw_response = self.raw.get_work_instant_messenger_username(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
