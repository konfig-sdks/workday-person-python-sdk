...
from workday_person_python_sdk.model.person_photo6b9baf67ce60100007d43c79e7a30011 import PersonPhoto6b9baf67ce60100007d43c79e7a30011 as PersonPhoto6b9baf67ce60100007d43c79e7a30011Schema
...
from workday_person_python_sdk.pydantic.person_photo6b9baf67ce60100007d43c79e7a30011 import PersonPhoto6b9baf67ce60100007d43c79e7a30011 as PersonPhoto6b9baf67ce60100007d43c79e7a30011Pydantic
...
SchemaFor200ResponseBodyApplicationJson = PersonPhoto6b9baf67ce60100007d43c79e7a30011Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PersonPhoto6b9baf67ce60100007d43c79e7a30011
...
class BaseApi(api_client.Api):
    ...
    def _get_personal_photo_mapped_args(
        self,
        id: str,
        subresource_id: str,
    ...
    async def _aget_personal_photo_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/people/{ID}/photos/{subresourceID}',
            headers=_headers,
        )
...
class GetPersonalPhotoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_personal_photo(
        self,
        id: str,
        subresource_id: str,
        **kwargs,
        ...
        args = self._get_personal_photo_mapped_args(
            id=id,
            subresource_id=subresource_id,
        )
        return await self._aget_personal_photo_oapg(
    ...
    def get_personal_photo(
        ...
        return self._get_personal_photo_oapg(
            path_params=args.path,
        )

class GetPersonalPhoto(BaseApi):
    ...
    async def aget_personal_photo(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PersonPhoto6b9baf67ce60100007d43c79e7a30011Pydantic:
        raw_response = await self.raw.aget_personal_photo(
            id=id,
            subresource_id=subresource_id,
            **kwargs,
        )
        if validate:
            return RootModel[PersonPhoto6b9baf67ce60100007d43c79e7a30011Pydantic](raw_response.body).root
        return api_client.construct_model_instance(PersonPhoto6b9baf67ce60100007d43c79e7a30011Pydantic, raw_response.body)
    ...
    def get_personal_photo(
        ...
        raw_response = self.raw.get_personal_photo(
            id=id,
            subresource_id=subresource_id,
        )
        if validate:
