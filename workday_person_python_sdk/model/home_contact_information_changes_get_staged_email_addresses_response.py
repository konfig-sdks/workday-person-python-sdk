...
class HomeContactInformationChangesGetStagedEmailAddressesResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['EmailAddressReference0918d433e86b100018119edc1b8f00f7']:
                        return EmailAddressReference0918d433e86b100018119edc1b8f00f7
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['EmailAddressReference0918d433e86b100018119edc1b8f00f7'], typing.List['EmailAddressReference0918d433e86b100018119edc1b8f00f7']],
                ...
                def __getitem__(self, i: int) -> 'EmailAddressReference0918d433e86b100018119edc1b8f00f7':
