...
class WorkContactInformationChangesGetWebAddressesStagedResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['WebAddressReferenceE357ae6d466510000ce259f323be01b0']:
                        return WebAddressReferenceE357ae6d466510000ce259f323be01b0
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['WebAddressReferenceE357ae6d466510000ce259f323be01b0'], typing.List['WebAddressReferenceE357ae6d466510000ce259f323be01b0']],
                ...
                def __getitem__(self, i: int) -> 'WebAddressReferenceE357ae6d466510000ce259f323be01b0':
