...
class BusinessProcessParameters83f6f6b7c38d100009c69131dea04a14(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["overallBusinessProcess", "action", "comment", "comments", "transactionStatus", "warningValidations", "overallStatus", "attachments", "criticalValidations", "for", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["overallBusinessProcess", "action", "comment", "comments", "transactionStatus", "warningValidations", "overallStatus", "attachments", "criticalValidations", "for", ], str]):
